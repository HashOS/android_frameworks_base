    ...
    public void systemReady(IAppOpsService appOps) {
        ...
        if (mButtonBrightnessSupport){
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.HASH_CUSTOM_BUTTON_BRIGHTNESS),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.HASH_CUSTOM_BUTTON_USE_SCREEN_BRIGHTNESS),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.HASH_BUTTON_BACKLIGHT_ENABLE),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.HASH_HARDWARE_KEYS_DISABLE),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_BUTTON_BACKLIGHT_TIMEOUT),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.HASH_BUTTON_BACKLIGHT_ON_TOUCH_ONLY),
                    false, mSettingsObserver, UserHandle.USER_ALL);
        }
    }
    ...
    private void updateButtonLightSettings() {
        ...
        if (mButtonBrightnessSupport){
            mCustomButtonBrightness = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.HASH_CUSTOM_BUTTON_BRIGHTNESS,
                    mCustomButtonBrightness, UserHandle.USER_CURRENT);
            mButtonUseScreenBrightness = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.HASH_CUSTOM_BUTTON_USE_SCREEN_BRIGHTNESS,
                    0, UserHandle.USER_CURRENT) != 0;
            mButtonBacklightEnable = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.HASH_BUTTON_BACKLIGHT_ENABLE,
                    1, UserHandle.USER_CURRENT) != 0;
            boolean hardwareKeysDisable = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.HASH_HARDWARE_KEYS_DISABLE,
                    0, UserHandle.USER_CURRENT) != 0;
            ...
            mButtonBacklightOnTouchOnly = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.HASH_BUTTON_BACKLIGHT_ON_TOUCH_ONLY,
                    0, UserHandle.USER_CURRENT) != 0;
