    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.Secure.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_SYSTEM_PROXI_CHECK_ENABLED), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_NAVIGATION_BAR_SHOW), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_USE_BOTTOM_GESTURE_NAVIGATION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_VOLUME_ROCKER_WAKE), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_VOLUME_BUTTON_MUSIC_CONTROL), false, this,
                    UserHandle.USER_ALL);
            updateSettings();
        }
    ...
    private void powerLongPress() {
        ...
        case LONG_PRESS_POWER_GLOBAL_ACTIONS:
            ...
            boolean globalActionsOnLockScreen = Settings.System.getInt(
                    mContext.getContentResolver(), Settings.System.HASH_POWERMENU_LOCKSCREEN, 0) == 0;
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mVolumeRockerWake = Settings.System.getIntForUser(resolver,
                    Settings.System.HASH_VOLUME_ROCKER_WAKE, 0, UserHandle.USER_CURRENT) != 0;
            ...
            mProxiWakeupCheckEnabled = Settings.System.getIntForUser(resolver,
                    Settings.System.HASH_SYSTEM_PROXI_CHECK_ENABLED, 0,
                    UserHandle.USER_CURRENT) != 0;
            mHasNavigationBar = DeviceUtils.deviceSupportNavigationBar(mContext);
            mUseGestureButton = Settings.System.getIntForUser(resolver,
                    Settings.System.HASH_USE_BOTTOM_GESTURE_NAVIGATION, 0,
                    UserHandle.USER_CURRENT) != 0;
            mVolumeMusicControl = Settings.System.getIntForUser(resolver,
                    Settings.System.HASH_VOLUME_BUTTON_MUSIC_CONTROL, 0,
                    UserHandle.USER_CURRENT) != 0;
        }
        ...
        if (mDeviceKeyHandler != null) {
            try {
                ...
                if (!interactive && eventLaunchActivity != null) {
                    ...
                    wakeUp(event.getEventTime(), mAllowTheaterModeWakeFromKey, "android.policy:KEY");
                    HashUtils.launchKeyguardDismissIntent(mContext, UserHandle.CURRENT, eventLaunchActivity);
                    result &= ~ACTION_PASS_TO_USER;
                    return result;
                }
