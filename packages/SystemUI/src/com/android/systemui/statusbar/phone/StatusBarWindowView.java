...
public class StatusBarWindowView extends FrameLayout {
    ...
    public void updateSettings() {
        boolean doubleTapToSleepEnabled = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_DOUBLE_TAP_SLEEP_GESTURE, 0,
                UserHandle.USER_CURRENT) == 1;
        boolean isDoubleTapEnabled = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_DOUBLE_TAP_SLEEP_LOCKSCREEN, 0,
                UserHandle.USER_CURRENT) == 1;
