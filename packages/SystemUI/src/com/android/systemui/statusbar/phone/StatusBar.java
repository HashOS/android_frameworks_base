...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private class HashSettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                    Settings.System.HASH_USE_OLD_MOBILETYPE),
                    false, this, UserHandle.USER_ALL);
        ...
        public void update() {
            int showNavBar = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.HASH_NAVIGATION_BAR_SHOW,
            ...
            USE_OLD_MOBILETYPE = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.HASH_USE_OLD_MOBILETYPE, 0,
    ...
    public void start() {
        ...
        mHashSettingsObserver = new HashSettingsObserver(mHandler);
        mHashSettingsObserver.observe();
        mHashSettingsObserver.update();
    }
