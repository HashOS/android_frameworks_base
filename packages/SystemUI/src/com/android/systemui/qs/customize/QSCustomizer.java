...
public class QSCustomizer extends LinearLayout implements OnMenuItemClickListener {
    ...
    private void reset() {
        ...
        Settings.System.putIntForUser(mContext.getContentResolver(),
                Settings.System.HASH_QS_LAYOUT_COLUMNS, mDefaultColumns,
                UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(mContext.getContentResolver(),
                Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, mDefaultColumns,
                UserHandle.USER_CURRENT);
        updateSettings();
    }
    ...
    public void updateSettings() {
        ...
        int columns = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_QS_LAYOUT_COLUMNS, mDefaultColumns,
                UserHandle.USER_CURRENT);
        int columnsLandscape = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, mDefaultColumns,
                UserHandle.USER_CURRENT);
