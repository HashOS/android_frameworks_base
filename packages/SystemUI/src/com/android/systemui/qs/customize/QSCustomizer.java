...
public class QSCustomizer extends LinearLayout implements OnMenuItemClickListener {
    ...
    public QSCustomizer(Context context, AttributeSet attrs) {
        ...
        int qsTitlesValue = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.HASH_QS_TILE_TITLE_VISIBILITY, 1,
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_columns_three:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS, 3, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_four:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS, 4, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_five:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS, 5, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_six:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS, 6, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_seven:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS, 7, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_eight:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS, 8, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_three:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, 3, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_four:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, 4, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_five:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, 5, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_six:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, 6, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_seven:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, 7, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_columns_landscape_eight:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, 8, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_titles:
                item.setChecked(!item.isChecked());
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_TILE_TITLE_VISIBILITY, item.isChecked() ? 1 : 0,
                        UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_rows_one:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_ROWS, 1, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_rows_two:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_ROWS, 2, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_rows_three:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_ROWS, 3, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_rows_four:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_ROWS, 4, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_rows_landscape_one:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_ROWS_LANDSCAPE, 1, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_rows_landscape_two:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_ROWS_LANDSCAPE, 2, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_rows_landscape_three:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_ROWS_LANDSCAPE, 3, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_rows_landscape_four:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_LAYOUT_ROWS_LANDSCAPE, 4, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_qs_columns_six:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_QUICKBAR_COLUMNS, 6, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_qs_columns_seven:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_QUICKBAR_COLUMNS, 7, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_qs_columns_eight:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_QUICKBAR_COLUMNS, 8, UserHandle.USER_CURRENT);
                break;
            case R.id.menu_item_qs_columns_auto:
                Settings.System.putIntForUser(mContext.getContentResolver(),
                        Settings.System.HASH_QS_QUICKBAR_COLUMNS, -1, UserHandle.USER_CURRENT);
                break;
            }
        updateSettings();
        return false;
    ...
    public void updateSettings() {
        ...
        int columns = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_QS_LAYOUT_COLUMNS, defaultColumns,
                UserHandle.USER_CURRENT);
        int columnsLandscape = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_QS_LAYOUT_COLUMNS_LANDSCAPE, defaultColumns,
                UserHandle.USER_CURRENT);
        boolean showTitles = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_QS_TILE_TITLE_VISIBILITY, 1,
    ...
    private void updateColumnsMenu(int defaultColumns, int defaultRows) {
        ...
        int rows = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_QS_LAYOUT_ROWS, defaultRows,
                UserHandle.USER_CURRENT);
        ...
        int rowsLandscape = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_QS_LAYOUT_ROWS_LANDSCAPE, defaultRows,
                UserHandle.USER_CURRENT);
        ...
        int qsColumns = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.HASH_QS_QUICKBAR_COLUMNS,
