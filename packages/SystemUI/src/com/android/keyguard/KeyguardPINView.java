...
public class KeyguardPINView extends KeyguardPinBasedInputView {
    ...
    protected void onFinishInflate() {
        ...
        boolean scramblePin = (Settings.System.getIntForUser(getContext().getContentResolver(),
                Settings.System.HASH_LOCKSCREEN_PIN_SCRAMBLE_LAYOUT, 0, UserHandle.USER_CURRENT) == 1);
        ...
        boolean quickUnlock = (Settings.System.getIntForUser(getContext().getContentResolver(),
                Settings.System.HASH_LOCKSCREEN_QUICK_UNLOCK_CONTROL, 0, UserHandle.USER_CURRENT) == 1);
         if (quickUnlock) {
